...
public class As4Servlet extends CXFNonSpringServlet {
	...
	protected void loadBus(ServletConfig servletConfig) {
		...
		try {
			...
			/**
			 * Try-catch made to avoid RuntimeException like "Soap 1.2 endpoint already
	...
	private SoapInterceptor createWsInInterceptor(Crypto crypto) {
		...
		inProps.put(WSHandlerConstants.SIGNATURE_PARTS,
				"{}{}Body; {}{http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/} Messaging; {}cid:Attachments;");
